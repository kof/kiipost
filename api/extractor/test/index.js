...
test('extract 1', function() {
    ...
    extractor.extract('http://appbusinesspodcast.com/jan-lehnardt-hoodie/')(function(err, _data) {
        equal(err, null, 'no errors')
        deepEqual(_data, data, 'data correct')
        start()
    })
